...
import com.ecotrack.api.service.ProductService;
...
/**
 * REST controller for managing {@link com.ecotrack.api.domain.Product}.
 */
@RestController
...
public class ProductResource {
    ...
    public ResponseEntity<ProductDTO> createProduct(@Valid @RequestBody ProductDTO productDTO) throws URISyntaxException {
        ...
        if (productDTO.getSku() != null && productRepository.findBySku(productDTO.getSku()).isPresent()) {
            throw new BadRequestAlertException("A product with this SKU already exists", ENTITY_NAME, "skuexists");
        }
    ...
    /**
     * {@code GET  /products/sku/:sku} : get product by SKU.
     *
    ...
    public ResponseEntity<ProductDTO> getProductBySku(@PathVariable("sku") String sku) {
        ...
        Optional<ProductDTO> productDTO = productService.findBySku(sku);
        return ResponseUtil.wrapOrNotFound(productDTO);
    }

    /**
     * {@code GET  /products/category/:category} : get all products by category.
     *
