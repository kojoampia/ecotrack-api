...
import com.ecotrack.api.config.Constants;
import com.ecotrack.api.domain.User;
import com.ecotrack.api.repository.AuthorityRepository;
...
import com.ecotrack.api.service.dto.PasswordChangeDTO;
import com.ecotrack.api.web.rest.vm.KeyAndPasswordVM;
import com.ecotrack.api.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@ecopster.com");
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.email").value("john.doe@ecopster.com"))
