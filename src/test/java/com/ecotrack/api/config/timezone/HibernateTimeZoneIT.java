package com.ecotrack.api.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.ecotrack.api.IntegrationTest;
import com.ecotrack.api.repository.timezone.DateTimeWrapper;
import com.ecotrack.api.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
 ...
 * - GitHub Issue: https://github.com/ecopster/generator-ecopster/issues/22579
 * - Pull Request: https://github.com/ecopster/generator-ecopster/pull/22946
 */
@IntegrationTest
class HibernateTimeZoneIT {
    ...
    void storeOffsetTimeWithZoneIdConfigShouldBeStoredOnConfiguredTimeZoneAccordingToHis1stJan1970Value() {
        ...
        String expectedValue = dateTimeWrapper
            ...
            // this behavior looks a bug, refer to https://github.com/ecopster/generator-ecopster/issues/22579.
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM eco_date_time_wrapper where id=%d", fieldName, id);
    }
